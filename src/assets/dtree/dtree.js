...
dTree.prototype.node = function(node, nodeId) {
	...
	if (node.url) {
		...
		str += '<a onclick="javascript: ' + this.obj + '.o(' + nodeId + ');" class="node" style="cursor:pointer">';
	str += node.name;
...
dTree.prototype.indent = function(node, nodeId) {
	...
	if (this.root.id != node.pid) {
		...
		if (node._hc) {
			str += '<a style="cursor:pointer" onclick="javascript: ' + this.obj + '.o(' + nodeId + ');"><img id="j' + this.obj + nodeId + '" src="';
